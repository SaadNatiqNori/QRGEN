...
export default function ServiceCard({ category, index }) {
    ...
    return (
        <div key={index} className="relative bg-white shadow-sm flex flex-col justify-center items-center gap-5 min-w-[135px] md:w-[135px] h-[135px] rounded-2xl overflow-hidden p-2 cursor-pointer">
