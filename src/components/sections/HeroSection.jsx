...
export default function HeroSection() {
    return (
        <section className='relative w-full min-h-[70vh] md:min-h-[80vh] flex flex-col justify-center items-center gap-7 md:gap-14 px-8' id='hero-section'>
            {/* Non Mobile */}
            ...
            <p className='font-extralight text-2xl hidden md:block'>
                Discover how companies similar to yours use QR codes strategically.
            </p>
            {/* Mobile */}
            <h1 className='text-3xl block md:hidden text-center'>
            ...
            <p className='font-extralight text-lg block md:hidden text-center leading-5'>
